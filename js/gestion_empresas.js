 ...
 * Archivo: js/gestion_empresas.js
 *
 * Partes del archivo:
 ...
 * - `setStatus` (línea aprox. 19): Asigna/actualiza estado.
 * - `revealDeferredPage` (línea aprox. 23): Bloque funcional del módulo.
 * - `fmtDate` (línea aprox. 29): Bloque funcional del módulo.
 * - `fmtMoney` (línea aprox. 36): Bloque funcional del módulo.
 * - `escapeHtml` (línea aprox. 42): Bloque funcional del módulo.
 * - `getPlanes` (línea aprox. 50): Obtiene un valor o recurso.
 * - `getPlanOptions` (línea aprox. 66): Obtiene un valor o recurso.
 * - `renderRows` (línea aprox. 80): Renderiza/actualiza UI.
 *
